...
//  ARShooting
//
//  Created by UserName on 2020/05/19.
...
class ARShootingView: UIView, ARSessionDelegate {
    ...
    @objc func simulatorBulletShot() {
        ...
        // 弾丸を生成
        let enemy = BulletSphere(startPosition: hitBox.position, entityName: EntityName.enemyBullet)
    ...
    func bulletShotCode(named entityName: String, for anchor: ARAnchor) {
        ...
        // 自分自身の弾丸を生成
        let bulletEntity = BulletSphere(startPosition: anchorEntity.position, entityName: entityName)
